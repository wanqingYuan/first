                        ...
                        <div class="table-box">
                                ...
                                <div class="form-group form-inline">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-default"
                                                onclick="location.href='${pageContext.request.contextPath}/pages/product-add.jsp'" title="新建">
                                            <i class="fa fa-file-o"></i> 新建</button>

                                        <button type="submit" onclick="productForm.action='${pageContext.request.contextPath}/product/delete.do';productForm.submit();" class="btn btn-default"  title="删除">
                                            <i class="fa fa-trash-o"></i> 删除</button>

                                        <button type="submit" onclick="productForm.action='${pageContext.request.contextPath}/product/open.do';productForm.submit();" class="btn btn-default" title="开启">
                                            <i class="fa fa-check"></i> 开启</button>

                                        <button type="submit" onclick="productForm.action='${pageContext.request.contextPath}/product/close.do';productForm.submit();" class="btn btn-default" title="屏蔽">
                            ...
                            <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                                ...
                                <tr>
                                    ...
                                    <th class="sorting_asc sorting_asc_disabled">目标城市</th>
                                ...
                                <c:forEach var="product" items="${pageInfo.list}">
                                    <tr>
                                        <td><input name="ids" id="ids" value="${product.id}" type="checkbox"></td>
                                        <td>${product.id}</td>
